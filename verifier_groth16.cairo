...
#Data reception needs to be changed in order to accomodate split up numbers (will receive 3 nubers instead of one)
...
#Gathers each group of 3 numbers in input, and groups them as a BigInt3 in output
